...
def normalize_snapshot(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    # Keep the public GitHub ledger research-only. Portfolio-specific fields are
    # rejected by prediction_ledger.validate_prediction().
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Record one immutable formal CIS research snapshot with standard evaluation horizons"
    )
